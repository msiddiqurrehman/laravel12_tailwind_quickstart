<x-admin-layout>
    <div class="p-4 mx-auto max-w-(--breakpoint-2xl) md:p-6">
        <!-- Breadcrumb Start -->
        <div x-data="{ pageName: `State List`, pages: [
            ...
            <div class="rounded-2xl border border-gray-200 bg-white dark:border-gray-800 dark:bg-white/[0.03]">
                <div class="flex justify-between px-5 py-4 sm:px-6 sm:py-5">
                    ...
                    @can('create', App\Models\State::class)
                        <a href="{{ route('admin.states.create') }}" class="text-theme-lg font-medium text-gray-500 dark:text-white/90">
                                ...
                                <tbody class="divide-y divide-gray-100 dark:divide-gray-800">
                                    ...
                                    <tr>
                                        ...
                                        <td class="px-5 py-4 sm:px-6">
                                            <div class="flex items-center">
                                                @can('update', $item)
                                                    <a href="{{ route('admin.states.edit', $item) }}" title="Edit" class="p-1 me-2.5 text-yellow-500">
                                                ...
                                                @can('delete', $item)
                                                    <form action="{{ route('admin.states.destroy', $item) }}" method="post" id="{{ 'form-delete-'.$item->id }}">
                                                        @csrf
                                                        @method('DELETE')
