    ...
    <nav x-data="{selected: $persist('Dashboard'), moduleName: '{{ $moduleName }}'}">
      ...
      <div>
        ...
        <ul class="flex flex-col gap-4 mb-6">
          ...
          <!-- Menu Item Modules -->
          @canany(['viewAny', 'create'], \App\Models\Module::class)
            <li>
              <a
                href="#"
          ...
          <!-- Menu Item Countries -->
          @canany(['viewAny', 'create'], \App\Models\Country::class)
            <li>
              <a
          ...
          <!-- Menu Item States -->
          @canany(['viewAny', 'create'], \App\Models\State::class)
            <li>
              <a
          ...
          <!-- Menu Item UserTypes -->
          @canany(['viewAny', 'create'], \App\Models\UserType::class)
            <li>
              <a
                href="#"
          ...
          @canany(['viewAny', 'create'], \App\Models\Designation::class)
            <li>
              <a
                href="#"
